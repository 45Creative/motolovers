...
export class SidenavService {
  ...
  constructor(
    ...
    let posts =  menu.addItem('Posts', 'subject', '/posts', 2);
    let profile =  menu.addItem('Profile', 'account_circle', '/profile', 3);


    menu.addItem('Inbox', 'mail', '/apps/inbox', 3, '22', '#7986CC');
    menu.addItem('Chat', 'chat', '/apps/chat', 4, '14', '#E15C74');
    menu.addItem('Calendar', 'date_range', '/apps/calendar', 5);

    let components =  menu.addItem('Components', 'layers', null, 4);
    ...
    let maps =  menu.addItem('Maps', 'map', null, 7, '3', '#4CAF50');
    menu.addSubItem(maps, 'Google Maps', '/maps/google-maps', 1);

    let icons = menu.addItem('Material Icons', 'grade', '/icons', 8);

    let customPages = menu.addItem('Custom Pages', 'web', null, 9);
    ...
    let dragAndDrop = menu.addItem('Drag & Drop', 'mouse', '/drag-and-drop', 10);

    let editor = menu.addItem('WYSIWYG Editor', 'format_shapes', '/editor', 11, 'NEW', '#3F51B5');
